    ...
    export function renderChapter(container, showVersiculo, nextChapter) {
        ...
        mostrarImagem(container, "assets/imagens/caverna.png", "Narrador dormindo");
        digitarTexto(container,
        "Em uma caverna escura e fria — a prisão de John Bunyan — o narrador repousa. Ele começa a sonhar com um homem chamado Cristão Peregrino, que carrega um fardo pesado nas costas e segura um livro firme nas mãos.",
        () => {
            // Cena 2: O homem lê e chora
            mostrarImagem(container, "assets/imagens/leitura.png", "Cristão lendo");
            digitarTexto(container,
            ...
            () => {
                ...
                mostrarImagem(container, "assets/imagens/familia.png", "Família em casa");
                digitarTexto(container,
                ...
                () => {
                    ...
                    mostrarImagem(container, "assets/imagens/duvida.png", "Família duvidando");
                    digitarTexto(container,
                    "A família o ignora. Acham que enlouqueceu. Ele passa a noite inquieto, chorando.",
                    () => {
                        // Cena 5: No dia seguinte
                        mostrarImagem(container, "assets/imagens/zombado.png", "Zombaria da família");
                        digitarTexto(container,
                        "Na manhã seguinte, reafirma seus temores, mas é zombado.",
                        () => {
                            // Cena 6: Ora e busca ajuda
                            mostrarImagem(container, "assets/imagens/campo.png", "Oração no campo");
                            digitarTexto(container,
                            ...
                            () => {
                                ...
                                mostrarImagem(container, "assets/imagens/evangelista.png", "Evangelista");
                                digitarTexto(container,
                                ...
                                () => {
                                    ...
                                    mostrarImagem(container, "assets/imagens/fuga.png", "Fuga da cidade");
                                    digitarTexto(container,
